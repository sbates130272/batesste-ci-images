...
## Build Shields (per artifact job status on main + PR into main)

| Artifact | main | PR into main |
| --- | --- | --- |
| ubuntu-base | [![ubuntu-base main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20Base%20Images)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-base pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20Base%20Images)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-libvfio-user | [![ubuntu-libvfio-user main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20Base%20Images)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-libvfio-user pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20Base%20Images)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-kernel-build | [![ubuntu-kernel-build main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-kernel-build)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-kernel-build pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-kernel-build)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-cuda-rocm | [![ubuntu-cuda-rocm main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-cuda-rocm)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-cuda-rocm pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-cuda-rocm)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-cuda-rocm-fio | [![ubuntu-cuda-rocm-fio main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-cuda-rocm-fio)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-cuda-rocm-fio pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-cuda-rocm-fio)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-cuda-rocm-fio-async-hipfile | [![ubuntu-cuda-rocm-fio-async-hipfile main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-cuda-rocm-fio%40async-hipfile)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-cuda-rocm-fio-async-hipfile pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-cuda-rocm-fio%40async-hipfile)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-rocm-nixl | [![ubuntu-rocm-nixl main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-rocm-nixl)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-rocm-nixl pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-rocm-nixl)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-rocm-ernic | [![ubuntu-rocm-ernic main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-rocm-ernic)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-rocm-ernic pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-rocm-ernic)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-rocm-rocjitsu | [![ubuntu-rocm-rocjitsu main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-rocm-rocjitsu)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-rocm-rocjitsu pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-rocm-rocjitsu)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-qemu-libvfio-user | [![ubuntu-qemu-libvfio-user main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-qemu-libvfio-user)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-qemu-libvfio-user pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-qemu-libvfio-user)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-qcow2-gen | [![ubuntu-qcow2-gen main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-qcow2-gen)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-qcow2-gen pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-qcow2-gen)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
| ubuntu-qcow2-gen-ionic | [![ubuntu-qcow2-gen-ionic main](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=push&job=Build%20ubuntu-qcow2-gen%40ionic)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apush) | [![ubuntu-qcow2-gen-ionic pr](https://img.shields.io/github/actions/workflow/status/sbates130272/batesste-ci-images/dockerfile-test.yml?branch=main&event=pull_request&job=Build%20ubuntu-qcow2-gen%40ionic)](https://github.com/sbates130272/batesste-ci-images/actions/workflows/dockerfile-test.yml?query=branch%3Amain+event%3Apull_request) |
